  ...
  <table align="center" border="0" cellpadding="1" cellspacing="1" style="width:950px;" >
   ...
   <table align="center" border="0" cellpadding="1" cellspacing="1" style="width:950px;" id="dvData">
	<tbody>
		...
		conectar(); mysql_set_charset('utf8'); 
		$sqlp = "SELECT * FROM Guia WHERE Fecha_Guia  >=  '" .$busqueda. "' and Fecha_Guia  <=  '" .$busqueda2. "' order by Fecha_Guia";  
		...
		$CT = $filap['Folio'];
			...
			IF ($Cliente == 58 or $Cliente == 50 and $Destino == 70 or $Destino == 47 or $Destino == 69 and $Prod == 70) {
			...
			conectar(); mysql_set_charset('utf8'); 
			$sqlddddqa = "SELECT * FROM transchofer WHERE nombretrans  =  '" .$idnombre. "'";  
		...
		<tr>
			...
			<td><P ALIGN=center><?php echo $mt3trans; ?></P></td>
