...
$sql = "SELECT * FROM cotizacion WHERE FOLIO = '" .$busqueda. "' GROUP BY IDCLIENTE";  
...
<table align="center" border="0" cellpadding="1" cellspacing="1" style="width:950px;" >
	...
	<tbody>
		<tr>
			<td width="20%">&nbsp;</td>
			<td width="20%">&nbsp;</td>
			<td width="20%"><input type="button" name="Cancelar" value=" Volver a Menú " onClick="location.href='VistaGral.php'"></td>
			<td width="20%">&nbsp;</td>
			<td width="20%">&nbsp;</td>
