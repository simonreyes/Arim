...
<html>
	...
	<META http-equiv=Content-Type content="text/html; charset=utf-8">
		<title>Reporte Guías por Rut</title>
		<style type="text/css">			
			* {
				margin:0px;
				padding:0px;
...
<div id ="block"></div>
   ...
   <p style="font-size:28px;font-family:Arial, Helvetica, sans-serif;"><font color="Blue"><b>TRANSPORTES EDGARDO CRISTIAN MORENO SOLIS E.I.R.L </b></font></p>
        <h3 class="title">Reporte Guía de Despacho por Rut Cliente</h3>
	    <div id="popupbox"></div>
        <div id="content"></div>
    </div>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
...
<form id="buscador" name="buscador" method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>"> 
   <table align="center" border="0" cellpadding="1" cellspacing="1" style="width:950px;" >
	 <tbody>
		<tr>
			<td>Ingrese RUT Cliente: <input id="buscar" name="buscar" type="search">
  ...
  <table align="center" border="0" cellpadding="1" cellspacing="1" style="width:950px;" >
	<tbody>
		...
		if($_POST){ 
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			RUT Cliente:&nbsp;&nbsp;&nbsp;&nbsp; <?php echo $busqueda; ?></font></P></td>
			<?php 		
		 }  
...
<div id="dvData">   
   <table align="center" border="0" cellpadding="1" cellspacing="1" style="width:950px;" id="dvData" >
	<tbody>
		...
		conectar(); mysql_set_charset('utf8'); 
		$sql = "SELECT * FROM guiadespacho WHERE id_cliente  =  '" .$idcliente. "'";  
		$resultado = mysql_query($sql); 		
		while($fila = mysql_fetch_assoc($resultado))
		{  
		$Num_Guia = "";  
