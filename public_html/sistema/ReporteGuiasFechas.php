...
<title>Reporte Guia de Despacho</title>
<!-- Fuentes -->
    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
						<h2>Reporte<b> Guía de Despacho</b></h2>
					</div>
                </div>
            </div>
			<div class="row">
					...
					<div class="input-daterange input-group" id="datepicker">
						...
						<span class="input-group-btn">
                            <button class="btn btn-info" type="button" onclick="BuscarClientes();">
                                Cargar Clientes <span class="fa fa-search"></span>
                            </button>
                        </span>
                    </div>
				</div>
                ...
                <div  class='col-sm-4'>
					<select id="selectCliente" name="selectCliente" class="form-control col-sm-4">
