    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
						<h2>Listado <b> Cotizaciones emitidas</b></h2>
					</div>
                </div>
            </div>
			<div class="row">
				<div id="custom-search-input"  class='col-sm-7 pull-left'>
					<div class="input-daterange input-group" id="datepicker">
    					...
    					<span class="input-group-btn">
                            <button class="btn btn-info" type="button" onclick="cargaListaCotizaciones();">
                                Cargar Cotizaciones <span class="fa fa-search"></span>
                            </button>
                        </span>
                    </div>
				</div>
