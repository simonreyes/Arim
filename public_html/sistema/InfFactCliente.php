...
<html>
	...
	<META http-equiv=Content-Type content="text/html; charset=utf-8">
		<title>Informe Detalle Factura</title>
		<style type="text/css">			
			* {
				margin:0px;
				padding:0px;
...
<div id ="block"></div>
   ...
   <p style="font-size:28px;font-family:Arial, Helvetica, sans-serif;"><font color="Blue"><b>ARIDOS Y TRANSPORTES EMS SPA </b></font></p>
        <h3 class="title">Informe Facturas Emitidas por Cliente</h3>
	    <div id="popupbox"></div>
        <div id="content"></div>
    </div>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
	 ...
	 <tbody>
		...
		<tr>
			<td><?php
				...
				{
				?>
				<option value=" <?php echo $row['Nombre_Cliente'] ?> " >
...
<div id="dvData">   
 ...
 <table align="center" border="0" cellpadding="1" cellspacing="1" style="width:950px;" id="dvData" >
	<tbody>		
		...
		$sql = "SELECT * FROM factura_emitidas WHERE nomemp  =  '" .$busqueda. "' 
		                                      and fechafact  >=  '" .$busqueda1. "' and fechafact  <=  '" .$busqueda2. "'";  
		...
		$numfact .= $fila['numfact'];    
		$fechafact .= $fila['fechafact']; 
		$montofact .= $fila['montofact']; 
		$estado .= $fila['estado']; 
