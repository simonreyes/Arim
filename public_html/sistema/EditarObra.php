...
<table align="center" border="1" cellpadding="1" cellspacing="1" style="width:950px;" >
	<tbody>
		...
		<tr>
			...
			<td><input readonly="readonly"  name="nombre" type="text" value="<?php echo $NombreCli; ?>" /></td>
			<td>&nbsp;</td>
			<td>Obra :</td>
			<td><input readonly="readonly" name="obra" type="text" value="<?php echo $busqueda2; ?>" /></td>
		</tr>
		<tr>
			<td>Dirección :</td>
			<td><input name="dirobra" type="text" value="<?php echo $dirobra; ?>" /></td>
			<td>&nbsp;</td>
			<td>Contacto :</td>
			<td><input name="contacto" type="text" value="<?php echo $contacto; ?>" /></td>
		</tr>
		<tr>
			<td>Fono :</td>
