<?php 
// esta cotizacion no lleva editar ni borrar, 
// llama a add.php para insertar un item
...
<table align="center" border="0" cellpadding="1" cellspacing="1" style="width:950px;" >
	...
	<tbody>
		<tr>
			<td width="20%">&nbsp;</td>
			<td width="20%">&nbsp;</td>
			<td width="20%"><input type="button" name="Cancelar" value="Inicio" onClick="location.href='DeleteCotiza.php'"></td>
			<td width="20%">&nbsp;</td>
			<td width="20%">&nbsp;</td>
		</tr>
	</tbody>
