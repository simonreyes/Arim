...
<form action="CancelaInserG.php" method="post" target="_blank" > 
   <table align="center" border="0" cellpadding="1" cellspacing="1" style="width:950px;" >
	 <tbody>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td>Detalle :</td>
			<td><textarea name="comentarios" rows="3" cols="6"></textarea></td>			
		</tr>		
    </tbody>
  </table>
  <table align="center" border="0" cellpadding="1" cellspacing="1" style="width:950px;" >
 ...
 <tr>
	...
	&nbsp;&nbsp;&nbsp;</td>	
   	<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>	
	<td><input type="submit" name="Guardarv" value=" Guardar " onClick="location.href='vistaGral.php'"></td>
