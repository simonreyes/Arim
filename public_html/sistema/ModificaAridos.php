...
dd{font-size:150%;}
	...
	<body>
        ...
        <h3 class="title">Modificar Aridos</h3>
	    <div id="popupbox"></div>
        <div id="content"></div>
    </div>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
...
<form action="ModAridos.php" method="post">			
...
<table align="center" border="1" cellpadding="1" cellspacing="1" style="width:950px;" >
	<tbody>
	    <tr>
			<td>Nuevo Valor</td>
			<td><input name="nvalor" id= "nvalor" type="text"/></td>	
			<td></td>
			<td>Nueva Sucursal</td>
			<td><input name="nsucursal" id= "nsucursal" type="text"/></td>	
		</tr>
		<tr>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
